...
appended when that anchor is absent. Only the structural `/home/aibox` identity
is restored unconditionally. A Component contributes its missing environment
